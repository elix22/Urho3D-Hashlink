...
urho3d-main: Urho3DGlue.o hashlink_main.o
	$(CC)  -O3 -o urho3d-main  $(INCLUDES)   hashlink_main.o  Urho3DGlue.o  $(APPLE_FLAGS)

hashlink_main.o: hashlink-c 
	$(CC) -c -O3 -o hashlink_main.o  $(INCLUDES) hashlink/hashlink_main.c 

hashlink-c:
	$(HAXE) -cp src --main Main --hl hashlink/hashlink_main.c

Urho3DGlue.o:
	$(CC) -c -O3 -o Urho3DGlue.o  $(INCLUDES)  $(SRC_DIR)/cpp/*.cpp   -std=c++11
